...
defmodule GoogleApi.AiPlatform.V1.Model.GoogleCloudAiplatformV1FetchFeatureValuesRequest do
  ...
  *   `format` (*type:* `String.t`, *default:* `nil`) - Specify response data format. If not set, KeyValue format will be used.
  *   `id` (*type:* `String.t`, *default:* `nil`) - Simple ID. The whole string will be used as is to identify Entity to fetch feature values for.
  """
