...
defmodule GoogleApi.AiPlatform.V1.Model.GoogleCloudAiplatformV1Feature do
  ...
  *   `versionColumnName` (*type:* `String.t`, *default:* `nil`) - Only applicable for Vertex AI Feature Store. The name of the BigQuery Table/View columnn hosting data for this version. If no value is provided, will use feature_id.
  """
