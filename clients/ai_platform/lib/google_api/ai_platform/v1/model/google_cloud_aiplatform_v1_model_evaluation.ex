...
defmodule GoogleApi.AiPlatform.V1.Model.GoogleCloudAiplatformV1ModelEvaluation do
  ...
  *   `metadata` (*type:* `any()`, *default:* `nil`) - The metadata of the ModelEvaluation. For the ModelEvaluation uploaded from Managed Pipeline, metadata contains a structured value with keys of "pipeline_job_id", "evaluation_dataset_type", "evaluation_dataset_path".
