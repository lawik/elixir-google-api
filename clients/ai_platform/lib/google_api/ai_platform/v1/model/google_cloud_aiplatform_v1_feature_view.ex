...
defmodule GoogleApi.AiPlatform.V1.Model.GoogleCloudAiplatformV1FeatureView do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Output only. Name of the FeatureView. Format: `projects/{project}/locations/{location}/featureOnlineStores/{feature_online_store}/featureViews/{feature_view}`
