...
defmodule GoogleApi.AiPlatform.V1.Model.GoogleCloudAiplatformV1FeatureViewSync do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Output only. Name of the FeatureViewSync. Format: `projects/{project}/locations/{location}/featureOnlineStores/{feature_online_store}/featureViews/{feature_view}/featureViewSyncs/{feature_view_sync}`
