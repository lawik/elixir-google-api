...
defmodule GoogleApi.AiPlatform.V1.Model.GoogleCloudAiplatformV1FeatureOnlineStore do
  ...
  *   `name` (*type:* `String.t`, *default:* `nil`) - Output only. Name of the FeatureOnlineStore. Format: `projects/{project}/locations/{location}/featureOnlineStores/{featureOnlineStore}`
