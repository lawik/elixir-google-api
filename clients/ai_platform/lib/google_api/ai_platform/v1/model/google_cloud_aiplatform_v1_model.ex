...
defmodule GoogleApi.AiPlatform.V1.Model.GoogleCloudAiplatformV1Model do
  ...
  *   `artifactUri` (*type:* `String.t`, *default:* `nil`) - Immutable. The path to the directory containing the Model artifact and any of its supporting files. Not present for AutoML Models or Large Models.
  ...
  *   `modelSourceInfo` (*type:* `GoogleApi.AiPlatform.V1.Model.GoogleCloudAiplatformV1ModelSourceInfo.t`, *default:* `nil`) - Output only. Source of a model. It can either be automl training pipeline, custom training pipeline, BigQuery ML, or existing Vertex AI Model.
