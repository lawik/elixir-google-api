...
defmodule GoogleApi.Chat.V1.Model.GoogleAppsCardV1TextInput do
  ...
  *   `placeholderText` (*type:* `String.t`, *default:* `nil`) - Text that appears in the text input field when the field is empty. Use this text to prompt users to enter a value. For example, `Enter a number from 0 to 100`. Supported by Google Chat apps, but not Google Workspace Add-ons.
